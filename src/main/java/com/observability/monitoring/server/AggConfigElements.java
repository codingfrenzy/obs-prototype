...
/**
 * AggConfigItems is the blueprint for the configuration elements required for aggregation. Objects of configuration 
 * should be created of this class. Every object will have several elements that are read from Collectd.conf, 
 * which is the configuration file of Collectd, the monitoring framework used in Observability project. Observability 
 * team decided to use the existing aggregation configurations from the configuration file to eliminate the number of 
 * configuration files used to configure the entire system. 
...
public class AggConfigElements implements Serializable{
	...
	private static final long serialVersionUID = 1L;
	    ...
	    private int interval;		// The interval of the aggregation, which is the time in seconds on which Observability 
	    							...
	    							// collected from the monitored nodes	
	    ...
	    private boolean calNum;		// ?investigate this
	     ...
	     * @param interval is the time in seconds of the integration interval
	     * @param plugin is the specified metric to be aggregated
	     * @param typeInst is metric type
	     * @param calNum 
	     * @param calSum is the status of the sum calculation
	     * @param calAvg is the status of the average calculation
	     * @param calMin is the status of the minimum calculation
	     * @param calMax is the status of the maximum calculation
	     * @param calStd is the status of the standard deviation calculation   
	     */
	    public AggConfigElements(int interval, String plugin, String typeInst, boolean calNum, boolean calSum, boolean calAvg,
		...
		/**
	     *    @param calNum which is the status of the ? calculation
	     */
