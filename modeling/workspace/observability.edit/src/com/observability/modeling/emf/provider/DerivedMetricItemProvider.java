...
/**
 * This is the item provider adapter for a {@link com.observability.modeling.emf.DerivedMetric} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DerivedMetricItemProvider extends MetricItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmfPackage.Literals.DERIVED_METRIC__HAS_PARENT_ELEMENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DerivedMetric.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfPackage.Literals.DERIVED_METRIC__HAS_PARENT_ELEMENT,
