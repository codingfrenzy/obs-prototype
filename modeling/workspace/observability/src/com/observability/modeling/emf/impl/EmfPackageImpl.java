...
public class EmfPackageImpl extends EPackageImpl implements EmfPackage {
	 ...
	 * @generated
	 */
	public EAttribute getNodeMachine_Warning() {
		return (EAttribute)nodeMachineEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(nodeMachineEClass, NODE_MACHINE__WARNING);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNodeMachine_Warning(), ecorePackage.getEString(), "warning", null, 0, 1, NodeMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
