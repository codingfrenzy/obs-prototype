...
public class KeyValueImpl extends MinimalEObjectImpl.Container implements KeyValue {
	...
	protected EClass eStaticClass() {
		return EmfPackage.Literals.KEY_VALUE;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfPackage.KEY_VALUE__KEY, oldKey, key));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfPackage.KEY_VALUE__VALUE, oldValue, value));
	}
