...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>emf</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EmfExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.emf"));
				DatabaseCluster root = EmfFactory.eINSTANCE.createDatabaseCluster();
