 ...
 * @generated
 */
public class Observability_emfSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Observability_emfSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Observability_emfPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Observability_emfPackage.DATABASE_CLUSTER: {
			...
			case Observability_emfPackage.METRIC: {
				Metric metric = (Metric)theEObject;
				T result = caseMetric(metric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Observability_emfPackage.DERIVED_METRIC: {
			...
			case Observability_emfPackage.BASE_METRIC: {
