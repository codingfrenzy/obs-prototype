...
/**
 * This is the item provider adapter for a {@link observability_new.DatabaseCluster} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatabaseClusterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Observability_newPackage.Literals.DATABASE_CLUSTER__COLLECTED_BASE_METRIC,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Observability_newPackage.Literals.DATABASE_CLUSTER__ASSOCIATED_DB_TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Observability_newPackage.Literals.DATABASE_CLUSTER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Observability_newPackage.Literals.DATABASE_CLUSTER__NO_OF_MACHINES,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Observability_newPackage.Literals.DATABASE_CLUSTER__COLLECTED_DERIVED_METRICS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Observability_newPackage.Literals.DATABASE_CLUSTER__MACHINES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Observability_newPackage.Literals.DATABASE_CLUSTER__MACHINES,
				 Observability_newFactory.eINSTANCE.createNodeMachine()));
	}
