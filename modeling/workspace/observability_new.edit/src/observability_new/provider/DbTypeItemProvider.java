...
/**
 * This is the item provider adapter for a {@link observability_new.DbType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DbTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Observability_newPackage.Literals.DB_TYPE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Observability_newPackage.Literals.DB_TYPE__PROBE_LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Collection Frequency feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCollectionFrequencyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DbType_collectionFrequency_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DbType_collectionFrequency_feature", "_UI_DbType_type"),
				 Observability_newPackage.Literals.DB_TYPE__COLLECTION_FREQUENCY,
				 true,
				 false,
				 false,
	...
	protected void addHasParentElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DbType_hasParentElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DbType_hasParentElement_feature", "_UI_DbType_type"),
		...
		newChildDescriptors.add
			(createChildParameter
				(Observability_newPackage.Literals.DB_TYPE__AVAILABLE_METRICS,
				 Observability_newFactory.eINSTANCE.createBaseMetric()));
